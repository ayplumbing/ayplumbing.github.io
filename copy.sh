...
sed -i 's/<title>[^<]*/<title>Basement \& Outdoor Plumbing Services - A \& Y Plumbing/' basement-plumbing-services/index.html
cp index.html basement-waterproofing/index.html
sed -i 's/<title>[^<]*/<title>Basement Waterproofing - A \& Y Plumbing/' basement-waterproofing/index.html
cp index.html bathroom-plumbing-services/index.html
sed -i 's/<title>[^<]*/<title>Bathroom Plumbing Services - A \& Y Plumbing/' bathroom-plumbing-services/index.html
cp index.html construction-and-renovations/index.html
sed -i 's/<title>[^<]*/<title>Construction \& Renovations - A \& Y Plumbing/' construction-and-renovations/index.html
cp index.html contact-form/index.html
sed -i 's/<title>[^<]*/<title>Contact Form - A \& Y Plumbing/' contact-form/index.html
cp index.html drain-services/index.html
sed -i 's/<title>[^<]*/<title>Drain Services - A \& Y Plumbing/' drain-services/index.html
cp  index.html kitchen-plumbing-services/index.html
sed -i 's/<title>[^<]*/<title>Kitchen Plumbing Services - A \& Y Plumbing/' kitchen-plumbing-services/index.html
